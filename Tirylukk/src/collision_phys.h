...
private:
	static void build_quad_grid(std::map<Uint32, SDL_Rect> & grid_map, const SDL_Rect& rect, int cell_count, int quad_count);//cell count is total in grid, quad count is per side, corners shared
